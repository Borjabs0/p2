...
public class AccidentDAO {
	...
	public void addCarToAccident(String reportNumber, String licenseId) throws DatabaseException {
		...
		try {
			...
			if (accident == null || car == null) {
				throw new DatabaseException("Accidente o coche no encontrado");
			}
