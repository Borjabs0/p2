				...
				case 1:
					...
					do {
						...
						try {
							...
							String address = LibIO.solicitarString("Introduzca la direccion", 10, 50);
							String name = LibIO.solicitarString("Introduzca el nombre del conductor", 3, 50);
							appService.addPerson(driverID.trim(), address, name);
				...
				case 1:
					...
					do {
						...
						try {
							...
							Integer year = LibIO.solicitarInt("Año", 1886, 2025);
							...
							appService.addCar(licenseId.trim(), model, year, driverId);
				...
				case 1:
					do {
						...
						try {
							...
							appService.addPolicy(policyID.trim(), licenseID.trim());
		...
		do {
			...
			try {
				...
				case 1:
					...
					appService.addAccident(reportNumber.trim(), location);
					appService.addCarAccident(licenseId.trim(), reportNumber.trim());
